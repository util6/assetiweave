...
```text
1. 仓库根 AGENTS.md
2. specs/feature-plans/SPEC_ Agent Marketplace 与动态运行时.md
3. specs/feature-plans/agent-marketplace-dynamic-runtime/08-implementation-plan.md 中目标 Task 全节
4. specs/feature-plans/agent-marketplace-dynamic-runtime/10-progress.md 当前状态
5. git status --short
```
...
- 修改冻结决策来适配实现捷径。
- 把目标架构提前写入 `specs/design.md` 当作当前事实。
