...
## 2. Background and current-state audit
...
### 6.1 One architecture, two usage modes
...
### 6.2 Recipes are shared infrastructure
...
### 6.3 Feature Skeletons are composition, not new infrastructure
...
### 6.4 Composition over page-specific variants
...
### 6.5 Static registry, no runtime mutation
