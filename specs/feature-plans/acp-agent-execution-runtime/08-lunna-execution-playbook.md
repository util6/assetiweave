...
- specs/feature-plans/acp-agent-execution-runtime/07-implementation-plan.md 中当前 Task
```
...
必须先读取：
1. 仓库根 AGENTS.md。
2. specs/feature-plans/SPEC_ ACP Agent Execution Runtime.md。
3. specs/feature-plans/acp-agent-execution-runtime/07-implementation-plan.md 中 {{TASK_ID}} 全节。
4. {{SPEC_SECTIONS}}。
5. {{SOURCE_FILES}}。
