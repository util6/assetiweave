#!/usr/bin/env node
/**
 * @file ChatGPT Web 会话解析适配器 (ChatGPT Web Adapter)
 * @description 负责读取 ChatGPT Web 导出 JSON（如 conversations.json），转换为 AssetIWeave 标准会话与问答 Turn/Part 结构。
 */
