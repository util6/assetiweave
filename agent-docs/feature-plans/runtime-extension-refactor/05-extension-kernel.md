...
- 关联 ADR:实施前落 `agent-docs/adr/0011-extension-kernel-shared-primitives.md`
...
- 文档:已淘汰的全局设计总册（以代码、测试与 ADR 为准） 增补 kernel 结构图(本 SPEC §1 图),并声明"新增市场型模块 = 新 PackageKind + DomainPackageSystem 实现 + seam,MUST NOT 新建垂直系统"。
