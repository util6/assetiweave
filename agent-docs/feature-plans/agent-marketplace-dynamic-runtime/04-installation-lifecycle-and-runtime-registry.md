# 安装生命周期与运行时注册表 (Installation Lifecycle and Runtime Registry)
...
### 1.4 已安装 / 已连接 / 执行就绪 (Installed / Connected / Execution Ready)
...
### 6.2 System 与 Managed 模式相互转换 (System <-> Managed)
