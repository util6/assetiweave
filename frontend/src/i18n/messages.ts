const zh = {
  ...
  "nav.sub.memory.overview": "今日 / 继续工作",
  ...
  "memory.overview.title": "今日 / 继续工作",
  "memory.overview.description": "聚合待继续事项、最近确认的 Memory 和 Dream 状态。",
  "memory.dreams.title": "自动 Dream",
  "memory.dreams.description": "管理增量 Dream、门禁状态和近期摘要。",
  "memory.task.running": "Memory 后台任务运行中",
  "memory.dreams.gates": "运行门禁",
  "memory.dreams.preview": "预览范围",
  "memory.dreams.sessions": "Session",
  "memory.dreams.questions": "问题",
  "memory.dreams.characters": "字符",
  "memory.dreams.actions": "Dream 操作",
  "memory.dreams.runNow": "立即 Dream",
  "memory.dreams.history": "Dream 历史",
  "memory.dreams.empty": "还没有 Dream Note。",
  "memory.dreams.detail": "Dream Note 详情",
  "memory.dreams.promote": "提升为候选",
  "memory.dreams.selectTitle": "选择一条 Dream Note",
  "memory.dreams.selectDescription": "查看 Markdown 摘要、证据和可执行操作。",
  "memory.dreams.browserTitle": "浏览器预览不运行 Dream",
  "memory.dreams.browserDescription": "请在桌面应用中查看门禁、运行 Dream 和管理 Note。",
  "memory.dreams.gate.enabled": "显式启用",
  "memory.dreams.gate.runtime": "AI Runtime",
  "memory.dreams.gate.time": "时间间隔",
  "memory.dreams.gate.sessions": "稳定 Session",
  "memory.dreams.gate.lock": "任务锁",
  "memory.dreams.gate.budget": "发送预算",
  "memory.overview.browserTitle": "浏览器预览不提供 Memory 聚合",
  "memory.overview.browserDescription": "请在桌面应用中查看本地 Overview。",
  "memory.overview.followUps": "待继续",
  "memory.overview.noFollowUps": "当前没有待继续事项。",
  "memory.overview.recent": "最近确认",
  "memory.overview.noRecent": "当前没有已确认的近期 Memory。",
  "memory.overview.latestDream": "最近 Dream",
  "memory.overview.noDream": "尚未生成 Dream Note。",
  "memory.overview.attention": "需要关注",
  "memory.overview.candidates": "待审核候选",
  "memory.overview.stale": "过期证据",
  "memory.overview.nextDream": "下一次 Auto-Dream 条件",
  "memory.freshness.verified": "证据已验证",
  "memory.freshness.changed": "证据已变化",
  "memory.freshness.missing": "证据缺失",
  "memory.freshness.unavailable": "来源不可用",
  "memory.recall.title": "深度回忆",
  "memory.recall.description": "通过本地证据与双阶段整理回答具体问题。",
  "memory.recall.strategy": "回忆策略",
  "memory.recall.exact": "精准回忆",
  "memory.recall.full": "完整整理",
  "memory.recall.query": "回忆问题",
  "memory.recall.queryPlaceholder": "例如：上次为什么选择 AppService 边界？",
  "memory.recall.projectPath": "项目路径",
  "memory.recall.projectPlaceholder": "完整整理必须指定项目范围",
  "memory.recall.includeUnavailable": "包含已保留但来源不可用的记录",
  "memory.recall.preview": "构建本地证据包",
  "memory.recall.synthesize": "AI 双阶段综合",
  "memory.recall.coverage": "覆盖范围",
  "memory.recall.total": "范围内总问题",
  "memory.recall.selected": "本批覆盖",
  "memory.recall.skipped": "尚未覆盖",
  "memory.recall.evidence": "证据 Card",
  "memory.recall.characters": "输入字符",
  "memory.recall.backend": "检索后端",
  "memory.recall.truncated": "已按预算截断",
  "memory.recall.answer": "带证据回答",
  "memory.recall.bundle": "本地 evidence bundle",
  "memory.recall.insufficient": "现有证据不足，回答中未把不确定内容当作事实。",
  "memory.recall.emptyTitle": "尚未构建证据包",
  "memory.recall.emptyDescription": "选择精准回忆或完整整理，先预览范围；预览不会调用 AI。",
  "memory.recall.browserTitle": "浏览器预览不提供 Recall 数据",
  "memory.recall.browserDescription": "请在桌面应用中检索本地 Conversation 证据。",
  "memory.library.title": "Memory 库",
  "memory.library.description": "浏览正式 Memory、审核候选，并检查证据与修订历史。",
  "memory.library.loading": "正在加载 Memory 库…",
  "memory.library.browserTitle": "浏览器预览不提供 Memory 数据",
  "memory.library.browserDescription": "请在 AssetIWeave 桌面应用中浏览和修改正式 Memory。浏览器预览不会建立第二套持久化或规则引擎。",
  "memory.library.errorTitle": "无法加载 Memory 库",
  "memory.library.emptyTitle": "还没有正式 Memory",
  "memory.library.emptyDescription": "手工创建第一条 Memory，或在后续 Recall 与 Dream 流程中审核候选。",
  "memory.library.filteredEmptyTitle": "当前页没有匹配项",
  "memory.library.filteredEmptyDescription": "调整搜索词或筛选条件后再试。",
  "memory.library.listTitle": "Memory 列表",
  "memory.library.detailTitle": "Memory 详情",
  "memory.library.total": "共 {{count}} 项",
  "memory.library.page": "第 {{page}} / {{total}} 页",
  "memory.search.label": "搜索当前页 Memory",
  "memory.search.placeholder": "搜索当前页标题或内容",
  "memory.search.submit": "应用搜索",
  "memory.filter.kind": "按类型筛选",
  "memory.filter.status": "按状态筛选",
  "memory.filter.origin": "按来源筛选",
  "memory.filter.stale": "按新鲜度筛选",
  "memory.filter.allKinds": "全部类型",
  "memory.filter.allStatuses": "全部状态",
  "memory.filter.allOrigins": "全部来源",
  "memory.filter.allFreshness": "全部新鲜度",
  "memory.filter.staleOnly": "仅证据异常",
  "memory.action.create": "新建 Memory",
  "memory.action.edit": "编辑 Memory",
  "memory.action.archive": "归档 Memory",
  "memory.action.directAccept": "直接接受",
  "memory.action.editAccept": "编辑后接受",
  "memory.action.reject": "拒绝候选",
  "memory.action.retry": "重试",
  "memory.action.previous": "上一页",
  "memory.action.next": "下一页",
  "memory.action.verify": "验证证据",
  "memory.action.refresh": "刷新 Memory",
  "memory.confirm.archive.title": "归档 Memory",
  "memory.confirm.archive.message": "归档后该条 Memory 将退出活动列表，但修订历史仍会保留。",
  "memory.confirm.archive.confirm": "确认归档",
  "memory.confirm.reject.title": "拒绝候选",
  "memory.confirm.reject.message": "拒绝后候选会保留审计记录，但不能再作为可审核候选。",
  "memory.confirm.reject.confirm": "确认拒绝",
  "memory.dialog.createTitle": "新建 Memory",
  "memory.dialog.editTitle": "编辑 Memory",
  "memory.dialog.acceptTitle": "编辑并接受候选",
  "memory.dialog.create": "创建",
  "memory.dialog.accept": "接受候选",
  "memory.field.kind": "类型",
  "memory.field.title": "标题",
  "memory.field.content": "内容",
  "memory.field.confidence": "置信度",
  "memory.field.appId": "App ID",
  "memory.field.sourceId": "Source ID",
  "memory.field.projectPath": "项目路径",
  "memory.field.sessionId": "Session ID",
  "memory.field.optionalHint": "可选；用于把 Memory 限定到更精确的工作范围。",
  "memory.detail.noSelection": "选择一条 Memory 查看内容、证据和修订历史。",
  "memory.detail.loading": "正在加载详情…",
  "memory.detail.scope": "范围",
  "memory.detail.metadata": "元数据",
  "memory.detail.evidence": "证据",
  "memory.detail.revisions": "修订历史",
  "memory.detail.noEvidence": "此条 Memory 暂无证据快照。",
  "memory.detail.noRevisions": "此条 Memory 暂无修订记录。",
  "memory.detail.confidence": "置信度 {{value}}",
  "memory.detail.updated": "更新于 {{value}}",
  "memory.detail.sourceRevision": "来源版本 {{value}}",
  "memory.detail.verifiedRevision": "已验证版本 {{value}}",
  "memory.evidence.location": "{{kind}} · Session {{session}} · Block {{block}}",
  "memory.evidence.sourceUnavailable": "原始来源当前不可用，以下为保留快照。",
  "memory.revision.title": "版本 {{number}} · {{change}}",
  "memory.kind.preference": "偏好",
  "memory.kind.decision": "决定",
  "memory.kind.method": "方法",
  "memory.kind.context": "上下文",
  "memory.kind.follow_up": "待继续",
  "memory.status.candidate": "候选",
  "memory.status.active": "活动",
  "memory.status.completed": "已完成",
  "memory.status.superseded": "已被替代",
  "memory.status.archived": "已归档",
  "memory.status.rejected": "已拒绝",
  "memory.origin.manual": "手工",
  "memory.origin.auto_dream": "自动 Dream",
  "memory.origin.deep_recall": "深度 Recall",
  "memory.origin.full_organize": "完整整理",
  "memory.stale.evidence_changed": "证据已变化",
  "memory.stale.evidence_missing": "证据缺失",
  "memory.stale.source_unavailable": "来源不可用",
  "memory.revision.create": "创建",
  "memory.revision.accept": "接受候选",
  "memory.revision.update": "编辑",
  "memory.revision.status": "状态变更",
  "memory.revision.supersedes": "替代关系",
  "conversation.navigation.sessionMissing": "无法定位这条 Memory 证据对应的 Session。",
  ...
  "settings.ai.externalWarning": "OpenCode / Gemini CLI 可能访问网络并具备本机能力。Memory 会在发送前和写入前执行确定性脱敏；Auto-Dream 默认关闭。",
  "settings.ai.autoDream": "自动 Dream",
  "settings.ai.autoDreamHint": "仅在时间、稳定 Session 数量和任务锁三重门禁通过后运行。开启后可能调用外部 CLI。",
  "settings.ai.autoDreamMinHours": "最小间隔",
  "settings.ai.autoDreamMinSessions": "最少新增 Session",
  ...
  "settings.agentCapabilities.memoryDescription": "使用所选 Agent 为 Memory 提取、整理和 Dream 提供模型能力。",
...
const en: Record<TranslationKey, string> = {
  ...
  "nav.sub.memory.overview": "Today / Continue",
  ...
  "memory.overview.title": "Today / Continue",
  "memory.overview.description": "Aggregate follow-ups, recently confirmed memories, and Dream status.",
  "memory.dreams.title": "Dreams",
  "memory.dreams.description": "Manage incremental Dreams, gate state, and recent summaries.",
  "memory.task.running": "Memory background task running",
  "memory.dreams.gates": "Run gates",
  "memory.dreams.preview": "Preview scope",
  "memory.dreams.sessions": "Sessions",
  "memory.dreams.questions": "Questions",
  "memory.dreams.characters": "Characters",
  "memory.dreams.actions": "Dream actions",
  "memory.dreams.runNow": "Dream now",
  "memory.dreams.history": "Dream history",
  "memory.dreams.empty": "No Dream Notes yet.",
  "memory.dreams.detail": "Dream Note details",
  "memory.dreams.promote": "Promote to candidates",
  "memory.dreams.selectTitle": "Select a Dream Note",
  "memory.dreams.selectDescription": "Review its Markdown summary, evidence, and available actions.",
  "memory.dreams.browserTitle": "Dream is unavailable in browser preview",
  "memory.dreams.browserDescription": "Use the desktop app to inspect gates, run Dreams, and manage Notes.",
  "memory.dreams.gate.enabled": "Explicit opt-in",
  "memory.dreams.gate.runtime": "AI Runtime",
  "memory.dreams.gate.time": "Time interval",
  "memory.dreams.gate.sessions": "Stable Sessions",
  "memory.dreams.gate.lock": "Task lock",
  "memory.dreams.gate.budget": "Send budget",
  "memory.overview.browserTitle": "Memory Overview is unavailable in browser preview",
  "memory.overview.browserDescription": "Use the desktop app to view the local Overview.",
  "memory.overview.followUps": "Continue next",
  "memory.overview.noFollowUps": "No active follow-ups.",
  "memory.overview.recent": "Recently confirmed",
  "memory.overview.noRecent": "No recently confirmed memories.",
  "memory.overview.latestDream": "Latest Dream",
  "memory.overview.noDream": "No Dream Note has been generated yet.",
  "memory.overview.attention": "Needs attention",
  "memory.overview.candidates": "Review candidates",
  "memory.overview.stale": "Stale evidence",
  "memory.overview.nextDream": "Next Auto-Dream conditions",
  "memory.freshness.verified": "Evidence verified",
  "memory.freshness.changed": "Evidence changed",
  "memory.freshness.missing": "Evidence missing",
  "memory.freshness.unavailable": "Source unavailable",
  "memory.recall.title": "Recall",
  "memory.recall.description": "Answer focused questions with local evidence and two-phase organization.",
  "memory.recall.strategy": "Recall strategy",
  "memory.recall.exact": "Exact recall",
  "memory.recall.full": "Full organize",
  ...
  "memory.recall.projectPlaceholder": "Full organize requires an explicit project scope",
  "memory.recall.includeUnavailable": "Include retained records whose source is unavailable",
  "memory.recall.preview": "Build local evidence bundle",
  "memory.recall.synthesize": "Two-phase AI synthesis",
  "memory.recall.coverage": "Coverage",
  "memory.recall.total": "Questions in scope",
  "memory.recall.selected": "Covered in batch",
  "memory.recall.skipped": "Not covered",
  "memory.recall.evidence": "Evidence cards",
  "memory.recall.characters": "Input characters",
  "memory.recall.backend": "Retrieval backend",
  "memory.recall.truncated": "Truncated to budget",
  "memory.recall.answer": "Evidence-backed answer",
  "memory.recall.bundle": "Local evidence bundle",
  "memory.recall.insufficient": "The available evidence is insufficient; uncertain content was not presented as fact.",
  "memory.recall.emptyTitle": "No evidence bundle yet",
  "memory.recall.emptyDescription": "Choose exact Recall or full organize and preview the scope first. Preview never invokes AI.",
  "memory.recall.browserTitle": "Recall data is unavailable in browser preview",
  "memory.recall.browserDescription": "Use the desktop app to search local Conversation evidence.",
  "memory.library.title": "Memory Library",
  "memory.library.description": "Browse formal memories, review candidates, and inspect evidence and revision history.",
  "memory.library.loading": "Loading the Memory Library…",
  "memory.library.browserTitle": "Memory data is unavailable in browser preview",
  "memory.library.browserDescription": "Use the AssetIWeave desktop app to browse and modify formal memories. Browser preview does not create a second persistence or rules engine.",
  "memory.library.errorTitle": "Unable to load the Memory Library",
  "memory.library.emptyTitle": "No formal memories yet",
  "memory.library.emptyDescription": "Create the first memory manually, or review candidates from future Recall and Dream workflows.",
  "memory.library.filteredEmptyTitle": "No matches on this page",
  "memory.library.filteredEmptyDescription": "Adjust the search text or filters and try again.",
  "memory.library.listTitle": "Memory list",
  "memory.library.detailTitle": "Memory details",
  "memory.library.total": "{{count}} items",
  "memory.library.page": "Page {{page}} of {{total}}",
  "memory.search.label": "Search memories on this page",
  "memory.search.placeholder": "Search titles or content on this page",
  "memory.search.submit": "Apply search",
  "memory.filter.kind": "Filter by kind",
  "memory.filter.status": "Filter by status",
  "memory.filter.origin": "Filter by origin",
  "memory.filter.stale": "Filter by freshness",
  "memory.filter.allKinds": "All kinds",
  "memory.filter.allStatuses": "All statuses",
  "memory.filter.allOrigins": "All origins",
  "memory.filter.allFreshness": "All freshness states",
  "memory.filter.staleOnly": "Evidence issues only",
  "memory.action.create": "New Memory",
  "memory.action.edit": "Edit Memory",
  "memory.action.archive": "Archive Memory",
  "memory.action.directAccept": "Accept now",
  "memory.action.editAccept": "Edit before accepting",
  "memory.action.reject": "Reject candidate",
  "memory.action.retry": "Retry",
  "memory.action.previous": "Previous page",
  "memory.action.next": "Next page",
  "memory.action.verify": "Verify evidence",
  "memory.action.refresh": "Refresh memories",
  "memory.confirm.archive.title": "Archive Memory",
  "memory.confirm.archive.message": "The memory will leave the active list while its revision history remains available.",
  "memory.confirm.archive.confirm": "Archive",
  "memory.confirm.reject.title": "Reject candidate",
  "memory.confirm.reject.message": "The candidate remains in the audit trail but will no longer be reviewable.",
  "memory.confirm.reject.confirm": "Reject",
  "memory.dialog.createTitle": "New Memory",
  "memory.dialog.editTitle": "Edit Memory",
  "memory.dialog.acceptTitle": "Edit and accept candidate",
  "memory.dialog.create": "Create",
  "memory.dialog.accept": "Accept candidate",
  ...
  "memory.field.appId": "App ID",
  "memory.field.sourceId": "Source ID",
  "memory.field.projectPath": "Project path",
  "memory.field.sessionId": "Session ID",
  "memory.field.optionalHint": "Optional. Use these fields to scope the memory to a more precise workspace.",
  "memory.detail.noSelection": "Select a memory to inspect its content, evidence, and revision history.",
  "memory.detail.loading": "Loading details…",
  "memory.detail.scope": "Scope",
  "memory.detail.metadata": "Metadata",
  "memory.detail.evidence": "Evidence",
  "memory.detail.revisions": "Revision history",
  "memory.detail.noEvidence": "This memory has no evidence snapshots yet.",
  "memory.detail.noRevisions": "This memory has no revision records yet.",
  "memory.detail.confidence": "Confidence {{value}}",
  "memory.detail.updated": "Updated {{value}}",
  "memory.detail.sourceRevision": "Source revision {{value}}",
  "memory.detail.verifiedRevision": "Verified revision {{value}}",
  "memory.evidence.location": "{{kind}} · Session {{session}} · Block {{block}}",
  "memory.evidence.sourceUnavailable": "The original source is unavailable; this is the retained snapshot.",
  "memory.revision.title": "Revision {{number}} · {{change}}",
  "memory.kind.preference": "Preference",
  "memory.kind.decision": "Decision",
  "memory.kind.method": "Method",
  "memory.kind.context": "Context",
  "memory.kind.follow_up": "Follow-up",
  ...
  "memory.origin.auto_dream": "Auto-Dream",
  "memory.origin.deep_recall": "Deep Recall",
  "memory.origin.full_organize": "Full organize",
  "memory.stale.evidence_changed": "Evidence changed",
  "memory.stale.evidence_missing": "Evidence missing",
  "memory.stale.source_unavailable": "Source unavailable",
  "memory.revision.create": "Created",
  "memory.revision.accept": "Candidate accepted",
  "memory.revision.update": "Edited",
  "memory.revision.status": "Status changed",
  "memory.revision.supersedes": "Supersedes link",
  "conversation.navigation.sessionMissing": "The Session referenced by this Memory evidence could not be located.",
  ...
  "settings.ai.externalWarning": "OpenCode or Gemini CLI may access the network and may have local machine capabilities. Memory applies deterministic redaction before sending and before persistence; Auto-Dream is off by default.",
  "settings.ai.autoDream": "Auto-Dream",
  "settings.ai.autoDreamHint": "Runs only after the time, stable-session, and task-lock gates pass. Enabling it may invoke an external CLI.",
  "settings.ai.autoDreamMinHours": "Minimum interval",
  "settings.ai.autoDreamMinSessions": "Minimum new sessions",
  ...
  "settings.agentCapabilities.memoryDescription": "Use the selected Agent for Memory extraction, consolidation, and Dream.",
