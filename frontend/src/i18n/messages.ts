const zh = {
  ...
  "settings.promptOptimization.systemPromptPlaceholder": "可使用 {targetLanguage}、{targetLanguageJson}、{content} 占位符。",
...
const en: Record<TranslationKey, string> = {
  ...
  "settings.promptOptimization.systemPromptPlaceholder": "Supports {targetLanguage}, {targetLanguageJson}, and {content} placeholders.",
  "settings.agents.title": "Agents",
