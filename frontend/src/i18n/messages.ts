const zh = {
  ...
  "settings.resetConfirmMessage": "所有自定义设置都将恢复为默认值，此操作会覆盖当前设置。",
  "settings.resetConfirmAction": "恢复默认",
  ...
  "settings.agents.registryDefinitionHint": "该 Agent 已接入内置 Registry；连接测试会执行真实 ACP 初始化。当前版本的定义编辑入口暂未开放。",
  ...
  "conversation.content.execution": "执行",
...
const en: Record<TranslationKey, string> = {
  ...
  "settings.resetConfirmTitle": "Restore default settings?",
  "settings.resetConfirmMessage": "All custom settings will be restored to their defaults and overwrite the current settings.",
  "settings.resetConfirmAction": "Restore defaults",
  ...
  "settings.agents.registryDefinitionHint": "This Agent is registered in the built-in Registry; connection testing performs a real ACP initialization. Editing the definition is not exposed yet.",
  ...
  "conversation.content.execution": "Execution",
