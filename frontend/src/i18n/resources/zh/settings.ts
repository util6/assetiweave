export const settingsZh = {
  ...
  "settings.memory.generation": "近期记忆生成 Agent",
  ...
  "settings.memory.recentWindow": "近期记忆窗口",
  "settings.memory.hours": "{{hours}} 小时",
  "settings.memory.watermarkTime1": "第一水位时间",
  "settings.memory.watermarkTime2": "第二水位时间",
  "settings.memory.generationSkill": "Memory Generation Skill",
  "settings.memory.builtinGenerationSkill": "使用内置 Generation Skill",
  "settings.memory.duplicateSkill": "复制为可编辑 Skill",
  "settings.memory.skillDuplicated": "已复制并启用可编辑 Skill",
  "settings.memory.skillReset": "已恢复内置 Generation Skill",
  "settings.memory.maintenance": "记忆维护",
  "settings.memory.manualGenerateTitle": "生成近期记忆",
  "settings.memory.manualGenerateDescription":
    "无需等待每日定时水位（02:00 / 14:00），随时主动提取近期活跃会话事实，并生成/刷新手账导轨与行动建议。",
  "settings.memory.generateRecentNow": "立即生成近期记忆",
  "settings.memory.generatingRecent": "正在生成...",
  "settings.memory.statusIdle": "就绪",
  "settings.memory.statusRunning": "正在提取近期会话并生成快照...",
  "settings.memory.statusQueued": "近期记忆任务已入队...",
  "settings.memory.statusCompleted": "近期记忆已生成",
  "settings.memory.statusFailed": "生成失败：{{message}}",
  "settings.memory.advancedMaintenance": "高级维护",
  "settings.memory.rebuildRecent": "生成 Recent Snapshot",
  "settings.memory.rebuildAll": "重建全部记忆层",
  "settings.memory.repairProjection": "修复 Markdown 投影",
  "settings.memory.rebuildQueued": "已提交 {{count}} 个任务",
  ...
  "settings.agents.modelError.modelListEmpty": "当前 Agent 未声明可选模型列表",
  "settings.agents.modelError.catalogInvalid": "Agent 返回的模型列表格式无效",
  "settings.agents.modelError.timeout": "模型发现超时",
  "settings.agents.modelError.unsupported": "Agent 不支持动态模型切换",
  "settings.agents.modelError.failed": "模型发现失败",
