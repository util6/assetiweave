export const settingsEn = {
  ...
  "settings.memory.generation": "Recent Memory generation Agent",
  ...
  "settings.memory.recentWindow": "Recent memory window",
  "settings.memory.hours": "{{hours}} hours",
  "settings.memory.watermarkTime1": "First watermark time",
  "settings.memory.watermarkTime2": "Second watermark time",
  "settings.memory.generationSkill": "Memory Generation Skill",
  "settings.memory.builtinGenerationSkill": "Use the built-in Generation Skill",
  "settings.memory.duplicateSkill": "Duplicate editable Skill",
  "settings.memory.skillDuplicated": "Editable Skill duplicated and enabled",
  "settings.memory.skillReset": "Built-in Generation Skill restored",
  "settings.memory.maintenance": "Memory maintenance",
  "settings.memory.manualGenerateTitle": "Generate Recent Memory",
  "settings.memory.manualGenerateDescription":
    "Trigger analysis of recent active sessions immediately without waiting for daily scheduled watermarks (02:00 / 14:00).",
  ...
  "settings.memory.advancedMaintenance": "Advanced Maintenance",
  "settings.memory.rebuildRecent": "Generate Recent Snapshot",
  "settings.memory.rebuildAll": "Rebuild all memory layers",
  "settings.memory.repairProjection": "Repair Markdown projections",
  "settings.memory.rebuildQueued": "Queued {{count}} task(s)",
