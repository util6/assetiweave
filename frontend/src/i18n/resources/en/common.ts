export const commonEn = {
  ...
  "tasks.section.failures": "Failures & Audit Trail",
  "tasks.status.queued": "Queued",
  "tasks.status.running": "Running",
  "tasks.status.succeeded": "Succeeded",
  "tasks.status.failed": "Failed",
  "tasks.status.cancelled": "Cancelled",
  "tasks.status.partial": "Partial Success",
  "tasks.search.placeholder": "Search task title, ID or kind...",
  "tasks.empty.noMatch": "No matching task records found",
} as const;
