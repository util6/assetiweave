...
export function AiExecutionTaskIndicator() {
  ...
  return (
    <section
      aria-live="polite"
      className="ui-task-indicator pointer-events-auto fixed bottom-5 right-5 z-40 flex w-[min(24rem,calc(100vw-2.5rem))] items-center gap-3 rounded-2xl border px-4 py-3 text-on-surface"
      role="status"
    >
