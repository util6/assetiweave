...
const themes = [
  defineTheme({
    ...
    mode: "dark",
    swatches: ["#080e1c", "#1c2639", "#5dd4f4", "#ed7ebe"],
    tokens: {
      palette: {
        background: "8 14 28",
        surface: "19 26 43",
        surfaceLowest: "5 9 18",
        surfaceLow: "12 18 32",
        surfaceCard: "28 38 57",
        surfaceHigh: "40 52 73",
        surfaceHighest: "53 69 92",
        border: "68 92 118",
        outline: "150 169 190",
        outlineVariant: "92 112 137",
        onSurface: "235 245 250",
        onSurfaceVariant: "177 196 215",
        primary: "203 241 255",
        primaryStrong: "93 212 244",
        gridLine: "160 190 220",
      },
      status: {
        update: "112 175 255",
        create: "73 214 181",
        remove: "237 126 190",
        conflict: "247 199 100",
      },
      surface: {
        pageGlow: "78 152 255",
        pageSheen: "220 106 196",
        cardBg: "28 39 59",
        cardBorder: "68 92 118",
        cardHeader: "15 23 39",
        subnavBg: "12 20 34",
        toolbarBg: "14 22 38",
      },
      ...
      navigation: {
        ...
        hover: "31 45 64",
        active: "39 49 76",
        activeFg: "220 247 255",
        activeBorder: "91 210 243",
        indicator: "237 126 190",
      },
      button: {
        primaryBg: "74 176 235",
        primaryHover: "75 210 239",
      ...
      effect: {
        ...
        panelShadow: "4 11 24",
        glow: "93 212 244",
        focusRing: "93 212 244",
        scrim: "3 8 18",
        glassOpacity: "0.72",
        hoverLift: "subtle",
      },
      component: {
        cardShadow: "0 20px 55px rgb(var(--theme-panel-shadow) / 0.34)",
