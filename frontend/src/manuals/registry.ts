      ...
      sections: [
        {
          heading: "使用方式",
          items: [
            "先选择项目范围，再发送问题；每次只能运行一轮，完成后可继续追问。",
            "回答只保留答案、会话引用、内容引用和后续建议，点击来源可返回 Conversation 现场。",
            "取消、失败和重启后的不可恢复状态都保留在会话记录中，可从任务面板重试。",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          items: [
            "Select a project scope and send a question; only one turn runs at a time, then follow-up turns can continue the session.",
            "Answers contain only the answer, session references, content references, and follow-up suggestions; source buttons return to Conversation.",
            "Cancellation, failures, and restart-unavailable states remain durable and can be retried from the task surface.",
          ],
        },
      ],
    },
