          ...
          .map((item) => (
            <button
              className={clsx(
                ...
                item.id === activeId &&
                  "aurora-pill-tab-active border-theme-nav-active-border/35 bg-theme-nav-active text-theme-nav-active-fg shadow-[inset_0_-2px_0_rgb(var(--theme-nav-indicator)/0.52)]",
              )}
              key={item.id}
