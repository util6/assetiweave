...
import {
  getBackupableSkillAssets,
  getBackupableSkillAssetsByIds,
} from "./skillBackup";
...
describe("skill backup helpers", () => {
  ...
  it("resolves a unique backupable Skill list from member ids", () => {
    ...
    const backupable = getBackupableSkillAssetsByIds(assetsById, [
      "skill-a",
      "skill-a",
      "missing",
      "skill-b",
