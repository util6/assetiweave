...
export const fallbackAssets: Asset[] = [
  ...
  },
  {
    ...
    repository: {
      ...
      web_url:
        "https://github.com/util6/util6-agents/tree/main/skills/android-native-dev",
    },
    discovered_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
...
export const fallbackSkillGroups: AssetGroupDetail[] = [
  {
    group: {
      ...
      name: "Frontend",
      description:
        "React, browser testing, UI design, and web delivery skills.",
      color: "#10b981",
      asset_kind: "skill",
      enabled: true,
      sort_order: 0,
    ...
    manual_asset_ids: [
      "demo-algorithmic-art",
      "demo-android-native-dev",
      "demo-canvas-design",
    ],
  },
  {
    group: {
      ...
      description:
        "Skills used when building scripts, browser automation, and local workflows.",
      color: "#f59e0b",
      asset_kind: "skill",
      enabled: true,
      sort_order: 10,
...
export const fallbackAppShortcuts: AppShortcut[] = [
  {
    ...
    accentColor: appShortcutIconAccentColors.claude,
    enabled: true,
  },
  {
    profileId: "codex",
    ...
    accentColor: appShortcutIconAccentColors.codex,
    enabled: true,
  },
  {
    profileId: "gemini",
    profileName: "Gemini",
    appKind: "gemini",
    displayIcon: "app:gemini",
    accentColor: appShortcutIconAccentColors.gemini,
    enabled: true,
  },
  {
    profileId: "opencode",
    ...
    appKind: "opencode",
    displayIcon: "app:opencode",
    accentColor: appShortcutIconAccentColors.opencode,
    enabled: true,
  },
  {
    profileId: "cursor",
    profileName: "Cursor",
    appKind: "cursor",
    displayIcon: "app:cursor",
    accentColor: appShortcutIconAccentColors.cursor,
    enabled: true,
  },
  {
    ...
    appKind: "antigravity",
    displayIcon: "app:antigravity",
    accentColor: appShortcutIconAccentColors.antigravity,
    enabled: false,
  },
  {
    profileId: "openclaw",
    ...
    appKind: "openclaw",
    displayIcon: "app:openclaw",
    accentColor: appShortcutIconAccentColors.openclaw,
    enabled: false,
  },
  {
    profileId: "kiro",
    ...
    accentColor: appShortcutIconAccentColors.kiro,
    enabled: false,
  },
  {
    profileId: "zcode",
    ...
    accentColor: appShortcutIconAccentColors.zcode,
    enabled: false,
  },
  {
    profileId: "qoder",
    profileName: "Qoder",
    appKind: "qoder",
    displayIcon: "app:qoder",
    accentColor: appShortcutIconAccentColors.qoder,
    enabled: false,
  },
  {
    profileId: "hermes",
