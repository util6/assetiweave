...
export const recentMemorySessionSchema: z.ZodType<RecentMemorySession> =
  z.object({
...
export const recentMemoryEventTargetSchema: z.ZodType<RecentMemoryEventTarget> =
  z.object({
...
export const memoryContextResultSchema: z.ZodType<MemoryContextResult> =
  z.object({
    text: z.string(),
...
export const memoryRecallSearchResultSchema: z.ZodType<MemoryRecallSearchResult> =
  z.object({
    query: z.string(),
...
export const memoryRecallSessionSchema: z.ZodType<MemoryRecallSession> =
  z.object({
    id: z.string().min(1),
    status: z.enum([
      "active",
