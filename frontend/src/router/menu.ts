    ...
    mcp: [
      {
        ...
        routeKey: "mcp.overview",
        enabled: true,
      },
      {
        id: "servers",
        label: "Servers",
        routeKey: "mcp.servers",
        enabled: true,
      },
      {
        id: "configs",
        label: "Config Projection",
        routeKey: "mcp.configs",
        enabled: true,
      },
    ],
    prompts: [
      {
        id: "overview",
        label: "Prompt Overview",
        routeKey: "prompts.overview",
        enabled: true,
      },
      {
        id: "templates",
        label: "Templates",
        routeKey: "prompts.templates",
        enabled: true,
      },
      {
        id: "targets",
        label: "Target Apps",
        routeKey: "prompts.targets",
        enabled: true,
      },
    ],
    rules: [
      {
        id: "overview",
        label: "Rule Overview",
        routeKey: "rules.overview",
        enabled: true,
      },
      {
        id: "policies",
        label: "Policies",
        routeKey: "rules.policies",
        enabled: true,
      },
      {
        id: "conflicts",
        label: "Conflict Detection",
        routeKey: "rules.conflicts",
        enabled: true,
      },
    ],
    profiles: [
      {
        id: "overview",
        label: "App Overview",
        routeKey: "profiles.overview",
        enabled: true,
      },
      {
        id: "templates",
        label: "Profile Templates",
        routeKey: "profiles.templates",
        enabled: true,
      },
      {
        id: "plans",
        label: "Deployment Plans",
        routeKey: "profiles.plans",
        enabled: true,
      },
    ],
    conversations: [
