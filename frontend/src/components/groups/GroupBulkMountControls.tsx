    ...
    >
      ...
      >
        {availableShortcuts.map((shortcut) => {
          ...
          const label = t(
            allMounted ? "group.mount.unmount" : "group.mount.mount",
            {
          ...
          return (
            <button
              ...
              disabled={
                busy || !detail.group.enabled || skillAssets.length === 0
              }
              key={shortcut.profileId}
              onClick={() =>
                void onSetGroupMountProfile(shortcut.profileId, !allMounted)
              }
