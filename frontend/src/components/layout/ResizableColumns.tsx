      ...
      elements.push(
        <Separator
          ...
          className={cn(
            ...
            "ui-resize-handle before:absolute before:inset-y-0 before:left-1/2 before:w-px before:-translate-x-1/2 before:bg-theme-card-border",
      ...
      >
        ...
        >
          ...
          <div
            ...
            className={cn(
              "ui-scroll-thumb absolute top-1/2 h-2.5 -translate-y-1/2 rounded-full border border-theme-nav-active-border/70 bg-theme-control-fg/75 shadow-[0_1px_3px_rgb(var(--theme-panel-shadow)/0.35)] outline-none",
              maxScroll > 0
