...
>(({ className, ...props }, ref) => (
  <div
    className={cn(
      "flex flex-col gap-1.5 border-b border-theme-card-border bg-theme-card-header/70 px-4 py-3",
      className,
    )}
    ref={ref}
    {...props}
...
>(({ className, ...props }, ref) => (
  <h3
    className={cn("text-body-md font-bold text-on-surface", className)}
    ref={ref}
    {...props}
  />
));
