...
const COMMAND_SPECS: &[CommandSpec] = &[
    ...
    command!(
        ...
        Friendly,
        false,
        crate::backend::application::MemoryDreamScopeParams,
        Service => |service, params| service.memory_overview(params),
        &[param!("scope", "Optional Memory scope")],
        Some("assetiweave-cli memory overview"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.dream.status",
        "memory.dream.status",
        "Explain Auto-Dream gates and preview the stable incremental delta",
        Read,
        Friendly,
        false,
        crate::backend::application::MemoryDreamScopeParams,
        Service => |service, params| service.memory_dream_status(params),
        &[param!("scope", "Optional Memory scope")],
        Some("assetiweave-cli memory dream status"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.dream.preview",
        "memory.dream.preview",
        "Preview the stable incremental Dream input without AI or writes",
        Read,
        Friendly,
        false,
        crate::backend::application::MemoryDreamPreviewParams,
        Service => |service, params| service.preview_memory_dream(params),
        &[
            param!("scope", "Optional Memory scope"),
            param!("trigger", "Automatic or manual gate semantics"),
        ],
        Some("assetiweave-cli memory dream preview"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.dream.run",
        "memory.dream.run",
        "Run a bounded incremental Dream and persist its note atomically",
        Write,
        Friendly,
        true,
        crate::backend::application::MemoryDreamRunParams,
        Service => |service, params| service.run_memory_dream(params),
        &[
            param!("scope", "Optional Memory scope"),
            param!("trigger", "Automatic or manual gate semantics"),
            param!("dry_run", "Preview without AI or writes", ["dryRun"]),
        ],
        Some("assetiweave-cli memory dream run"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.dream.list",
        "memory.dream.list",
        "List persisted Dream notes",
        Read,
        Friendly,
        false,
        crate::backend::application::MemoryDreamListParams,
        Service => |service, params| service.list_memory_dream_notes(params),
        &[
            param!("statuses", "Optional Dream note statuses"),
            param!("scope", "Optional exact Memory scope"),
            param!("limit", "Maximum number of notes"),
            param!("offset", "Pagination offset"),
        ],
        Some("assetiweave-cli memory dream list"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.dream.get",
        "memory.dream.get",
        "Get one Dream note with evidence",
        Read,
        Friendly,
        false,
        crate::backend::application::MemoryDreamGetParams,
        Service => |service, params| service.get_memory_dream_note(params),
        &[param!("note_id", "Dream note identifier", ["noteId"])],
        Some("assetiweave-cli memory dream get <note-id>"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.dream.archive",
        "memory.dream.archive",
        "Archive one Dream note",
        Write,
        Friendly,
        false,
        crate::backend::application::MemoryDreamGetParams,
        Service => |service, params| service.archive_memory_dream_note(params),
        &[param!("note_id", "Dream note identifier", ["noteId"])],
        Some("assetiweave-cli memory dream archive <note-id>"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.dream.promote",
        "memory.dream.promote",
        "Copy Dream bullets into reviewable formal Memory candidates",
        Write,
        Friendly,
        false,
        crate::backend::application::MemoryDreamGetParams,
        Service => |service, params| service.promote_memory_dream_note(params),
        &[param!("note_id", "Dream note identifier", ["noteId"])],
        Some("assetiweave-cli memory dream promote <note-id>"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.recall.preview",
        "memory.recall.preview",
        "Build an evidence-only exact Recall or full-organize preview",
        Read,
        Friendly,
        false,
        crate::backend::application::MemoryRecallPreviewParams,
        Service => |service, params| service.preview_memory_recall(params),
        &[
            param!("mode", "exact or full"), param!("scope", "Memory scope"),
            param!("query", "Recall question"), param!("since", "Inclusive start time"),
            param!("until", "Inclusive end time"),
            param!("include_unavailable", "Include bounded missing records", ["includeUnavailable"]),
            param!("limit", "Question page size"), param!("offset", "Question page offset"),
        ],
        Some("assetiweave-cli memory recall preview --query <question>"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.recall.run",
        "memory.recall.run",
        "Run evidence-only Recall or opt-in two-phase AI synthesis",
        Write,
        Friendly,
        true,
        crate::backend::application::MemoryRecallRunParams,
        Service => |service, params| service.run_memory_recall(params),
        &[
            param!("mode", "exact or full"), param!("scope", "Memory scope"),
            param!("query", "Recall question"), param!("synthesize", "Use external AI"),
            param!("dry_run", "Preview without writes", ["dryRun"]),
        ],
        Some("assetiweave-cli memory recall run --query <question>"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.verify",
        "memory.verify",
        "Verify freshness only for selected Memory evidence",
        Write,
        Friendly,
        false,
        crate::backend::application::MemoryVerifyParams,
        Service => |service, params| service.verify_memory(params),
        &[param!("item_ids", "Memory item identifiers", ["itemIds"])],
        Some("assetiweave-cli memory verify --item <item-id>"),
        since: "0.5.2", deprecated: false
    ),
    command!(
        "memory.item.list",
    ...
    command!(
        ...
        &[
            param!("mode", "exact or full"), param!("scope", "Memory scope"),
            param!("query", "Recall question"), param!("include_unavailable", "Include unavailable records", ["includeUnavailable"]),
            param!("limit", "Question page size"), param!("offset", "Question page offset"),
        ],
        None,
        since: "0.5.2", deprecated: false
