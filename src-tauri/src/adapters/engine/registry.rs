...
const COMMAND_SPECS: &[CommandSpec] = &[
    ...
    command!(
        ...
        "memory.context.resolve",
        "Resolve the bounded compiled Memory context for an optional project and query",
        Read,
        Friendly,
        false,
        ...
        &[
            ...
            param!("token_budget", "Maximum context token budget", ["tokenBudget"]),
        ],
        Some("assetiweave-cli memory context resolve"),
        since: "0.6.1", deprecated: false
    ),
    command!(
        "memory.project.get",
        "memory.project.get",
        "Get the current SQLite L2 project Memory view and source availability",
        Read,
        Friendly,
        false,
    ...
    command!(
        "memory.rebuild",
        "memory.rebuild",
        "Queue a Memory maintenance rebuild for recent, project, global, all, or projection repair",
        Write,
        Friendly,
        false,
        ...
        &[
            param!("scope", "Legacy optional Memory scope"),
            param!("target", "Rebuild target: recent, project, global, or all"),
            param!("project_path", "Project path required for project target", ["projectPath"]),
            param!("reason", "Rebuild reason: manual, migration, or projection_repair"),
        ],
        Some("assetiweave-cli memory rebuild --target <target>"),
        since: "0.6.1", deprecated: false
    ),
    command!(
        "memory.task.list",
        "memory.task.list",
        "List Memory background tasks",
        Read,
        Friendly,
        false,
        crate::backend::application::MemoryTaskListParams,
        Service => |service, params| service.list_memory_task_views(params),
        &[param!("active_only", "Only active tasks", ["activeOnly"])],
        Some("assetiweave-cli memory task list"),
        since: "0.6.1", deprecated: false
    ),
    command!(
        "memory.task.get",
        "memory.task.get",
        "Get one Memory background task",
        Read,
        Friendly,
        false,
        crate::backend::application::MemoryTaskGetParams,
        Service => |service, params| service.get_memory_task_view(params),
        &[param!("task_id", "Memory task identifier", ["taskId"])],
        Some("assetiweave-cli memory task get <task-id>"),
        since: "0.6.1", deprecated: false
    ),
    command!(
        "memory.task.cancel",
        "memory.task.cancel",
        "Cancel one active Memory background task",
        Write,
        Friendly,
        false,
        crate::backend::application::MemoryTaskGetParams,
        Service => |service, params| service.cancel_memory_task_view(params),
        &[param!("task_id", "Memory task identifier", ["taskId"])],
        Some("assetiweave-cli memory task cancel <task-id>"),
        since: "0.6.1", deprecated: false
    ),
    command!(
        "memory.task.retry",
        "memory.task.retry",
        "Retry one failed Memory background task",
        Write,
        Friendly,
        false,
    ...
    command!(
        ...
        "memory.recall.search",
        "Search Memory source content with deterministic hybrid ranking",
        Read,
        Friendly,
        false,
        ...
        Some("assetiweave-cli memory recall search --query <query>"),
        since: "0.6.1", deprecated: false
    ),
    command!(
        "memory.recall.session.create",
        "memory.recall.session.create",
        "Create a persistent Recall session",
        Write,
        Friendly,
        false,
    ...
    command!(
        ...
        "memory.recall.session.get",
        "Get a persistent Recall session and its turns",
        Read,
        Friendly,
        false,
    ...
    command!(
        ...
        "memory.recall.turn.send",
        "Queue one Recall turn in a persistent session",
        Write,
        Friendly,
        false,
        ...
        Some("assetiweave-cli memory recall turn send <session-id> --query <query>"),
        since: "0.6.1", deprecated: false
    ),
    command!(
        "memory.recall.turn.cancel",
        "memory.recall.turn.cancel",
        "Cancel the active Recall turn",
        Write,
        Friendly,
        false,
