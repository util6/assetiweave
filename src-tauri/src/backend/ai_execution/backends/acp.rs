...
use crate::backend::{
    ...
    ai_execution::{
        ...
        AiExecutionResult, AiExecutionSessionDeleteMethod, SessionCleanupStatus, SessionEvent,
...
fn memory_generation_mcp_servers(
    tools: Option<&crate::backend::ai_execution::AiMemoryGenerationTools>,
) -> Result<Vec<McpServer>, AiExecutionError> {
...
fn is_session_delete_failure(failure: &str) -> bool {
    matches!(
        failure,
...
fn determine_session_cleanup_status(cleanup: &CleanupReport) -> SessionCleanupStatus {
